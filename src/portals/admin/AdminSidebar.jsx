      ...
      <Box sx={{ flex: 1, overflow: "hidden" }}>
        {sections.map((sec) => (
          <Box key={sec.label} sx={{ mb: 1 }}>
            <Typography sx={{ px: 2.5, mb: 0.5, fontSize: "0.62rem", fontWeight: 700,
                ...
                return (
                  <ListItemButton key={item.path} onClick={() => navigate(item.path)}
                    sx={{
                      ...
                      ...(active && { "&::before": { content:'""', position:"absolute", left:0, top:"18%", bottom:"18%", width:3, borderRadius:"0 2px 2px 0", bgcolor:"#6366f1" } }),
                    }}>
            ...
            <Divider sx={{ borderColor: "rgba(255,255,255,0.05)", mx: 2, mt: 1 }} />
          </Box>
        ))}
      </Box>
    </Box>
