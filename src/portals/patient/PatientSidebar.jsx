...
export default function PatientSidebar() {
  ...
  return (
    <Box sx={{
          ...
          return (
            <ListItemButton key={item.path} onClick={() => navigate(item.path)}
              sx={{
                ...
                "&:hover": { bgcolor: active ? "rgba(124,58,237,0.25)" : "rgba(255,255,255,0.06)" },
                transition: "background 0.15s",
                ...(active && {
                  "&::before": { content:'""', position:"absolute", left:0, top:"20%", bottom:"20%", width:3, borderRadius:"0 2px 2px 0", bgcolor:"#a78bfa" },
                }),
              }}>
              <ListItemIcon sx={{ minWidth: 30, color: active ? "#a78bfa" : "rgba(255,255,255,0.35)" }}>
      ...
      <SidebarFooter accentColor={ACCENT} />
    </Box>
  );
}
