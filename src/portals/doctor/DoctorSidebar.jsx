...
const items = [
  ...
  { label: "Patients",      icon: <PersonIcon />,        path: "/doctor/patients" },
          ...
          return (
            <ListItemButton key={item.path} onClick={() => navigate(item.path)}
              sx={{
                ...
                ...(active && { "&::before": { content:'""', position:"absolute", left:0, top:"18%", bottom:"18%", width:3, borderRadius:"0 2px 2px 0", bgcolor:"#60a5fa" } }),
              }}>
